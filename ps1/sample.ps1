...
# full task
# . $builderShell -tasks @("CHECKOUT", "PATCH", "PROJECT", "BUILD") -clangVersion 390 -msvcVersion 2015 -platform 64 -configuration "Release" -cmakePath $cmake -msys2Path $msys2 -patchInfos $patches -target "Clang libraries\libclang;Clang executables\clang-format"
# . $builderShell -tasks @("CHECKOUT", "PATCH", "PROJECT", "BUILD") -clangVersion 390 -msvcVersion 2013 -platform 64 -configuration "Release" -cmakePath $cmake -msys2Path $msys2 -patchInfos $patches -target "Clang libraries\libclang;Clang executables\clang-format"
# . $builderShell -tasks @("CHECKOUT", "PATCH") -clangVersion 380 -msvcVersion 2013 -platform 64 -configuration "Release" -cmakePath $cmake -msys2Path $msys2 -patchInfos $patches -target "Clang libraries\libclang;Clang executables\clang-format"
# . $builderShell -tasks @("PROJECT") -clangVersion 390 -msvcVersion 2013 -platform 32 -configuration "Release" -cmakePath $cmake -msys2Path $msys2 -patchInfos $patches -target "Clang libraries\libclang;Clang executables\clang-format"
# . $builderShell -tasks @("PROJECT", "BUILD") -clangVersion 390 -msvcVersion 2013 -platform 32 -configuration "Release" -cmakePath $cmake -msys2Path $msys2 -patchInfos $patches -target "Clang libraries\libclang;Clang executables\clang-format"

# . $builderShell -tasks @("CHECKOUT", "PATCH") -clangVersion 390 -patchInfos $patches
# . $builderShell -tasks @("PATCH") -clangVersion 390 -patchInfos $patches
...
# . $builderShell -tasks @("CHECKOUT", "PATCH") -clangVersion 380 -patchInfos $patches
. $builderShell -tasks @("PATCH") -clangVersion 380 -patchInfos $patches
...
# . $builderShell -tasks @("PROJECT") -clangVersion 380 -msvcVersion 2013 -platform 32 -configuration "Release" -cmakePath $cmake -msys2Path $msys2 -patchInfos $patches -target "Clang libraries\libclang;Clang executables\clang-format"
# . $builderShell -tasks @("PROJECT", "BUILD") -clangVersion 390 -msvcVersion 2013 -platform 64 -configuration "Release" -cmakePath $cmake -msys2Path $msys2 -patchInfos $patches -target "Clang libraries\libclang;Clang executables\clang-format"

# . $builderShell -tasks @("CHECKOUT", "PATCH", "PROJECT", "BUILD") -clangVersion 380 -msvcVersion 2013 -platform 64 -configuration "Release" -cmakePath $cmake -msys2Path $msys2 -patchInfos $patches -target "Clang libraries\libclang;Clang executables\clang-format"


# libclang only
# . $builderShell -tasks @("CHECKOUT", "PATCH") -clangVersion 390 -patchInfos $patches
# . $builderShell -tasks @("PROJECT", "BUILD") -clangVersion 390 -platform 64 -configuration "Release" -cmakePath $cmake -msys2Path $msys2 -patchInfos $patches -target "Clang libraries\libclang"
# . $builderShell -tasks @("PROJECT", "BUILD") -clangVersion 390 -msvcVersion 2013 -platform 64 -configuration "Release" -cmakePath $cmake -msys2Path $msys2 -patchInfos $patches -target "Clang libraries\libclang"
# . $builderShell -tasks @("BUILD") -clangVersion 390 -msvcVersion 2015 -platform 64 -configuration "Debug" -cmakePath $cmake -msys2Path $msys2 -patchInfos $patches -target "Clang libraries\libclang"
# . $builderShell -tasks @("PROJECT", "BUILD") -clangVersion 390 -msvcVersion 2015 -platform 32 -configuration "Release" -cmakePath $cmake -msys2Path $msys2 -patchInfos $patches -target "Clang libraries\libclang"
...
# . $builderShell -tasks @("PROJECT") -clangVersion 390 -platform 64 -configuration "Release" -cmakePath $cmake -msys2Path $msys2
# . $builderShell -tasks @("PATCH") -clangVersion 390 -platform 64 -configuration "Release" -cmakePath $cmake -msys2Path $msys2 -patchInfos $patches
