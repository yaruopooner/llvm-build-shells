...
$llvmCheckoutTag = "llvmorg-8.0.0"
# $msvcProductName = 2019
$msvcProductName = 2017


# LLVM ALL Build (full task)
# executeBuilder -tasks @("CHECKOUT", "PATCH", "PROJECT", "BUILD") -llvmCheckoutTag $llvmCheckoutTag -msvcProductName $msvcProductName -platform 64 -configuration "Release" -cmakePath $cmake -pythonPath $python
...
# executeBuilder -tasks @("CHECKOUT", "PATCH", "PROJECT", "BUILD") -llvmCheckoutTag $llvmCheckoutTag -msvcProductName $msvcProductName -platform 64 -configuration "Release" -cmakePath $cmake -pythonPath $python -target $target


# LLVM Parts Build (parts task)
# $target = "Clang libraries\libclang;Clang executables\clang-format"
# executeBuilder -tasks @("CHECKOUT", "PATCH") -llvmCheckoutTag $llvmCheckoutTag
...
# $target = "Clang libraries\libclang;Clang executables\clang-format"
# executeBuilder -tasks @("CHECKOUT") -llvmCheckoutTag $llvmCheckoutTag -gitPath $git -llvmCheckoutTag $llvmCheckoutTag
# executeBuilder -tasks @("CHECKOUT", "PATCH") -llvmCheckoutTag $llvmCheckoutTag -gitPath $git -llvmCheckoutTag $llvmCheckoutTag
# executeBuilder -tasks @("CHECKOUT") -llvmCheckoutTag $llvmCheckoutTag -gitPath $git
# executeBuilder -tasks @("PATCH") -llvmCheckoutTag $llvmCheckoutTag
