...
# $cmake = "c:/cygwin-x86_64/tmp/cmake-3.6.2-win32-x86/bin"
# $cmake = "c:/cygwin-x86_64/tmp/cmake-3.4.0-win32-x86/bin"
...
$patchInfos = @( 
    @{
        applyLocation = "llvm/";
        absolutePath = "c:/cygwin-x86_64/home/William-Adama/.emacs.d/.emacs24/packages/user/ac-clang/clang-server/patch/invalidate-mmap.patch";
    }
)
...
# . $builderShell -tasks @( "PROJECT", "BUILD") -clangVersion 390 -msvcVersion 2015 -platform 64 -configuration "Release" -cmakePath $cmake -pythonPath $python -gnu32Path $gnu32 -patchInfos $patchInfos -target "Clang libraries\libclang;Clang executables\clang-format"
. $builderShell -tasks @( "PROJECT") -clangVersion 390 -msvcVersion 2015 -platform 64 -configuration "Release" -cmakePath $cmake -pythonPath $python -gnu32Path $gnu32 -patchInfos $patchInfos -target "Clang libraries\libclang;Clang executables\clang-format"
